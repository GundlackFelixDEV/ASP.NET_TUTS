 ...
 */
function CountDownController ($scope,CountDownService){
    $scope.CountDown = new CountDown(10,"#TimeOut");
        
    $scope.IsActive = function(){
        return $scope.CountDown.myStatus === CountDown.Status.Active;
    };
...
CountDownController.$inject = ['$scope','CountDownService'];
